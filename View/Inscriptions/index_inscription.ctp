    ...
    <div id="cartafiesta">
		<table>
			...
			<?php	
					...
					echo "</br>";
					echo "</br>";
					echo "•	Cámara de comercio, renovada a 2015, con una vigencia de 30 días.";
					echo "</br>";
					...
					echo "</br>";
					echo "</br>";
					echo 'Esperamos contar con su presencia en la 9a Fiesta del libro y la cultura. Agradecemos su participación, colaboración y puntualidad en las citas. En caso de no asistir a su cita o incumplir el horario de esta, su cupo será liberado y se asignará a otro postulante.'; 
					echo "</br>";
					echo "</br>";
					...
					echo "</br>";
					echo 'Jefe Comercial Eventos del Libro';
					echo "</br>";
